...
@section('title', 'Nouveaux paramètres de livraison')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Nouveaux paramètres de livraison</h5>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.delivery-settings.store') }}" method="POST">
                        @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" 
                                               ...
                                               value="{{ old('delivery_fee_per_commerce', 500) }}" 
                                               min="0" 
                                               step="50" 
                                               required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" 
                                               ...
                                               value="{{ old('first_order_discount', 500) }}" 
                                               min="0" 
                                               step="50" 
                                               required>
                                        <span class="input-group-text">F</span>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" 
                                               ...
                                               value="{{ old('free_delivery_threshold', 0) }}" 
                                               min="0" 
                                               step="1000">
                                        <span class="input-group-text">F</span>
                                    </div>
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="is_active">
                                            Activer ces paramètres immédiatement
                                        </label>
                                    </div>
                                    <div class="form-text">
