  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="#" class="menu-link">
            <div data-i18n="All Delivery">Tous les livreurs</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="#" class="menu-link">
            <div data-i18n="Add Delivery">Ajouter un livreur</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="#" class="menu-link">
            <div data-i18n="Delivery Status">Statut livreurs</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="#" class="menu-link">
            <div data-i18n="Delivery Performance">Performance</div>
          </a>
        </li>
      </ul>
    </li>
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="#" class="menu-link">
            <div data-i18n="All Categories">Toutes les catégories</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="#" class="menu-link">
            <div data-i18n="Add Category">Ajouter une catégorie</div>
          </a>
        </li>
      </ul>
    </li>
